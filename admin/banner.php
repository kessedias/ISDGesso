        ...
        <div class="row">
            <div class="col">
                ...
                <table class="table table-hover table-bordered" style="background-color: whitesmoke;">
                    ...
                    <h2 class="mt-4 text-center">Imagens Banner</h2>
                    ...
                    <thead class="thead-dark">
                        ...
                        <tr>
                            ...
                            <th scope="row"><?= $linha['id_ban']?></th>
                            <td><?= $linha['imgi_ban']?></td>
                            <td><?=$linha['imgii_ban']?></td>
                            <td><?=$linha['imgiii_ban']?></td>

                            <td>
                                <a href="banner_alterar.php?id_ban=<?= $linha['id_ban'];?>" class="btn btn-primary mb-1"><i
