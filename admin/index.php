        ...
        <div class="row">
            <div class="col">
                ...
                <table class="table table-hover table-bordered" style="background-color: whitesmoke;">
                    <h2 class="mt-4 text-center">Serviços</h2>

                    <?php include('mensagem.php');?> 

                    <a href="servico_criar.php" class="btn btn-success mb-2"><i class="fas fa-plus mr-1"></i>Novo
                        Serviço</a>
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col">Imagem Resumo</th>
                            <th scope="col">Imagem Conteúdo</th>
                            <th scope="col">&nbsp;</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th scope="row"><?= $linha['id_serv']?></th>
                            <td><?= $linha['titulo_intro_serv']?></td>
                            <td><?= $linha['img_intro_serv']?></td>
                            <td><?=$linha['img_cont_serv']?></td>

                            <td>
                                <a href="servico_alterar.php?id_serv=<?= $linha['id_serv'];?>" class="btn btn-primary mb-1"><i
                                        class="fas fa-pencil-alt mr-1"></i>Editar</a>
                                <a href="servico_excluir.php?id_serv=<?= $linha['id_serv'];?>" class="btn btn-danger mb-1"><i
